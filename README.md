...
**Description:** Classic bikes are a common sight across London, while electric shared bikes account for just 8% of total trips. This project began with data cleaning and processing, followed by descriptive statistical analysis to identify peak demand periods and locations. It concluded with the development of a predictive model achieving 67% accuracy in forecasting electric bike demand. The model is designed to support urban planning and guide the strategic expansion of the city’s cycling infrastructure.  
