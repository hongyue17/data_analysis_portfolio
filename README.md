...
**Code:** [`Repository`](https://github.com/hongyue17/unhealthy_shopping_behaviour_in_ASDA_morley), [`unhealthy_shopping_behaviour_in_ASDA_morley.ipynb`](https://github.com/hongyue17/unhealthy_shopping_behaviour_in_ASDA_morley/blob/main/unhealthy_shopping_behaviour_in_ASDA_morley.ipynb)  
**Presentation:**  [`Full Report`](https://github.com/hongyue17/unhealthy_shopping_behaviour_in_ASDA_morley/blob/main/Practical%20Briefing.pdf)  
...
**Code:** [`Repository`](https://github.com/hongyue17/electric_bike_usage_pattern_london), [`electric_bike_demand_forecast_london_py.ipynb`](https://github.com/hongyue17/electric_bike_usage_pattern_london/blob/master/electric_bike_demand_forecast_london_py.ipynb)  
**Presentation:** [`Brief`](https://github.com/hongyue17/electric_bike_usage_pattern_london), [`Full Report`](https://github.com/hongyue17/electric_bike_demand_forecast_london/blob/main/full_report.pdf)  
**Description:** Classic bikes are a familiar sight across London, while electric shared bikes account for just 8% of total journeys. This project commenced with data cleaning and processing, followed by descriptive statistical analysis to identify peak demand periods and locations. It culminated in the development of a predictive model with 67% accuracy in forecasting demand for electric bikes. The model is designed to optimise the allocation of electric bikes and inform future planning initiatives.  
**Results:** The study revealed distinct usage patterns between electric and classic bikes: electric bikes are predominantly used for commuting, while classic bikes are favored for leisure activities. Transit hubs were identified as the most frequented stations for electric bike usage. Leveraging factors such as station location, day of the week, and time of day, the predictive model offers valuable insights to optimize the availability and distribution of electric bikes throughout London.  
...
**Code & Report:** [`Repository`](https://github.com/hongyue17/stations_passenger_variation_elizabeth_line), [`stations_passenger_variation_elizabeth_line.ipynb`](https://github.com/hongyue17/stations_passenger_variation_elizabeth_line/blob/main/stations_passenger_variation_elizabeth_line.ipynb)  
...
**Code:** [`Repository`](https://github.com/hongyue17/genAI_property_investment_reports), [`chatgpt_api.ipynb`](https://github.com/hongyue17/genAI_property_investment_reports/blob/main/chatgpt_api.ipynb)  
...
**Code:** [`Main Code`](https://github.com/hongyue17/fairer_council_tax_london/blob/main/fairer_council_tax_london.ipynb), [`Property council tax data scrapped from GOV.UK`](https://github.com/hongyue17/fairer_council_tax_london/blob/main/postcode_scrap.ipynb)  
